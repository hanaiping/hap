...
public class GeneratorCode {
    ...
    private static String packageName = "com.rrk.capital.center";

    private static String outDir = "E:\\Temp";

    private static String entity = "entity";
    private static String dto = "entity";
    ...
    private static String dtoVM = "/templates/entity.java.vm";
    ...
    private static String[] baseDir = {entity, mapper, service, impl, controller,dto};
    ...
    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String... tableNames) {
        ...
        String dbUrl = "jdbc:mysql://42.51.1.30:3308/rrk-dev-capital?useUnicode=true&characterEncoding=utf8&useSSL=false";
        DataSourceConfig dataSourceConfig = new DataSourceConfig();
        dataSourceConfig.setDbType(DbType.MYSQL)
                .setUrl(dbUrl)
                .setUsername("root")
                .setPassword("wpx120516")
