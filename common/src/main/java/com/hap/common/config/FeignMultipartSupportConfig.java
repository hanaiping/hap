package com.hap.common.config;
import com.hap.common.constant.CommonConstant;
import com.hap.common.util.JsonUtils;
import com.hap.common.util.StringUtil;
    ...
    class UserErrorDecoder implements ErrorDecoder {
        ...
        public Exception decode(String methodKey, Response response) {
            ...
            try{
                ...
                com.hap.common.response.Response r= JsonUtils.fromJson(json, com.hap.common.response.Response.class);
                if(code!=200){
