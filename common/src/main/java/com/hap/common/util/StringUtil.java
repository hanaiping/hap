...
public class StringUtil {
    ...
    public final static String defaultVal(Object val, String defaultVal) {
...
//        }
    ...
    private final static String reg_isSQLFieldBySelect = "^[A-Za-z0-9,*_([A-Za-z0-9_]) ]+$";
    ...
    public final static boolean isSQLFieldBySelect(final String text) {
        ...
        if (!StringUtil.isOnceSQLField(str.substring(0, 1))) {
            return false;
        }
        System.out.println(str.substring(str.length() - 1));
        if (!StringUtil.isOnceSQLField(str.substring(str.length() - 1))) {
            return false;
        }

        return match(str, reg_isSQLFieldBySelect);
    }
    ...
    public final static boolean isEnglishOrNumeric(final String text) {
        ...
        return match(text.trim(), reg_isEnglishOrNumeric);
    }
